...
export function Landing() {
  ...
  return (
    <div className="ap-page">
      ...
      <main>
        <section className="ap-hero" id="topo">
          <div className="ap-hero-shape ap-hero-shape-one" />
          <div className="ap-hero-shape ap-hero-shape-two" />

          <div className="ap-container ap-hero-grid">
            <div className="ap-hero-copy ap-reveal">
              <span className="ap-eyebrow">Software para impressão e corte</span>
              <h1>Prepare faca, nesting e exportação em poucos cliques.</h1>
              <p>
                O PrintNest transforma arquivos de cliente em PDF de impressão e DXF de
                corte prontos para a máquina, com aproveitamento inteligente de material.
              </p>
              ...
              <div className="ap-actions">
                ...
                <a href="#demo" className="ap-demo-link">
                  <PlayCircle aria-hidden="true" /> Ver demonstração
                </a>
              </div>

              <div className="ap-proof-row" aria-label="Destaques">
            ...
            <div className="ap-hero-visual ap-reveal" style={{ ["--delay" as string]: "0.12s" }}>
              <div className="ap-phone-card">
                <div className="ap-phone-top">
                  <span />
                  <strong>Produção de hoje</strong>
                  <small>77% usado</small>
                </div>
                <img src="/assets/app-producao.jpg" alt="Interface do PrintNest Pro em produção" />
              </div>

              <div className="ap-floating-card ap-floating-card-one">
                <Zap aria-hidden="true" />
                <strong>435 peças</strong>
                <span>encaixadas automaticamente</span>
              </div>

              <div className="ap-floating-card ap-floating-card-two">
          ...
          <div className="ap-container ap-split-grid">
            <div className="ap-image-stack ap-reveal">
              <div className="ap-media-frame">
                <img src="/assets/hero-frames/ezgif-frame-018.jpg" alt="Prévia visual do fluxo de produção do PrintNest" />
              </div>
          ...
          <div className="ap-container">
            ...
            <div className="ap-screen-showcase ap-reveal">
              <div className="ap-screen-frame">
                <img src="/assets/hero-frames/ezgif-frame-035.jpg" alt="Frame de demonstração do PrintNest" />
              </div>
              <div className="ap-screen-strip">
                <img src="/assets/hero-frames/ezgif-frame-001.jpg" alt="Início do fluxo no PrintNest" />
                <img src="/assets/hero-frames/ezgif-frame-018.jpg" alt="Meio do fluxo no PrintNest" />
                <img src="/assets/hero-frames/ezgif-frame-051.jpg" alt="Final do fluxo no PrintNest" />
              </div>
            </div>
          </div>
        </section>
